// =============================================================================
// level/bsp.js — seeded BSP-деление футпринта на 2–4 комнаты.
...
/**
 * Строит планировку: комнаты {id,type,x,z,w,d} (x,z — центр в layout-координатах,
 * футпринт центрирован в нуле) и двери между смежными комнатами.
