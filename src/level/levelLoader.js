// =============================================================================
// level/levelLoader.js — декларативный пайплайн уровня:
// seeded-генератор → JSON → валидация схемой → нормализованный TaskContract.
// JSON — единственный источник правды для сборки сцены.
// =============================================================================
