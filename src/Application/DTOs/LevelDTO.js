export default class LevelDTO {
  constructor({ levelId, roomId, name, roomState, availableItems, constraints, styleId, targetScore = 3, compositionRules = {}, ergonomicsRules = {}, presentationEnvironment = null }) {
