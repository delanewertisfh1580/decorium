export default class LevelDTO {
  constructor({ levelId, roomId, name, roomState, baselineRoomState = null, availableItems, styleId, targetScore = 3, presentationEnvironment = null, clientBrief = null, evaluationSpec = null, interiorRecipe = null, generationSeed = null, surfaceFinishes = [], unlockedIds = [] }) {
