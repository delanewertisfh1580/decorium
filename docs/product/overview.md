...
| 3 | Читает brief: стили, запросы клиента, сценарии и ограничения. | Hydrated `ClientBrief v3` supplies versioned authored policy and the client's authored voice; UI displays it without interpretation. |
