...
| Ergonomics | [010](adr-010-ergonomics-clearance-scoring.md), [011](adr-011-authored-passage-zones.md), [015](adr-015-functional-layout-graph.md), [026](adr-026-client-clearance-multiplier.md), [027](adr-027-required-functional-scenarios.md) | Clearance, passage zones, semantic functional layout graph, client-specific effective clearance thresholds and required functional scenarios. |
| Scorecard calibration | [028](adr-028-scorecard-calibration-policy.md) | Versioned rating epsilon and critical caps preserve raw evaluation facts while producing authoritative completion eligibility outside UI. |
| Explainability | [029](adr-029-explainable-evaluation-contract.md) | Domain/Application counterfactual impact and authored evidence supply immutable explanation data; UI renders and focuses only. |
| Client-priority and multi-style scoring | [030](adr-030-client-priority-multi-style-scoring.md) | ClientBrief V2 activates exact weighted style targets, priority rules and spatial preferences through deterministic three-channel scoring and explanation V2. |
| Delivery | [014](adr-014-versioned-build-info-and-release-gate.md) | Build identity, release manifest и CI gate. |
| Presentation | [016](adr-016-authored-presentation-environment-profiles.md), [017](adr-017-presentation-catalog-context.md), [018](adr-018-data-driven-furniture-visual-families.md), [019](adr-019-asset-backed-furniture-presentation.md), [020](adr-020-pbr-texture-baking-pipeline.md), [021](adr-021-pbr-asset-manifest-conformance.md), [022](adr-022-catalog-family-asset-pack-completeness.md), [023](adr-023-versioned-room-identity-selectors.md), [024](adr-024-room-composition-asset-backed-environment.md), [025](adr-025-client-brief-source-policy.md) | Versioned scene profiles, catalog continuity, furniture families, resilient GLB prefab delivery, reproducible PBR texture baking, auditable PBR manifest conformance, complete catalog-family ownership, room identity selectors, lazy asset-backed room compositions and ClientBrief-owned evaluation policy, all isolated from UI-side gameplay calculation. |
