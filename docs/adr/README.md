...
| Ergonomics | [010](adr-010-ergonomics-clearance-scoring.md), [011](adr-011-authored-passage-zones.md), [015](adr-015-functional-layout-graph.md), [026](adr-026-client-clearance-multiplier.md) | Clearance, passage zones, semantic functional layout graph и client-specific effective clearance thresholds. |
