...
| Presentation | [016](adr-016-authored-presentation-environment-profiles.md) | Versioned authored scene profiles, explicit visual ownership and gameplay isolation. |
