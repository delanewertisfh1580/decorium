...
| Presentation | [016](adr-016-authored-presentation-environment-profiles.md), [017](adr-017-presentation-catalog-context.md), [018](adr-018-data-driven-furniture-visual-families.md) | Versioned scene profiles, catalog continuity and data-driven furniture families, all isolated from gameplay. |
