...
| Presentation | [016](adr-016-authored-presentation-environment-profiles.md), [017](adr-017-presentation-catalog-context.md) | Versioned scene profiles plus presentation-owned catalog continuity, both isolated from gameplay. |
